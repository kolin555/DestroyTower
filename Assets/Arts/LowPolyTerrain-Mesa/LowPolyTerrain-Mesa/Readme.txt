...
[Update V1.04, Mar 11 2021]
-Pirate theme added.(floor & props)


[Update V1.03, Feb 25 2021]
- Modular stream added.(6 stream modules + Scroll shader / See section 5)
...
1. File Naming
	...
	-Theme
	 ...
	 6. Mesa60 = Wood floor(V1.04 added)
...
5. Modular stream.
	You can create single passes and sloping streams.(Intersecting and T-shape is not supported)
	You can see an example with the "Demo_Mesa_Stream" scene.

	5-1 Shader. (UnlitScroller.shader)
		-It can be used as a "Fatty/Unlit Scroller" in the Material Inspector window.
		-Shaders are not affected by lighting.(Brightness needs to change the texture color in Photoshop)
		-It works on Unity 2017.4 or higher and also works on URP.
		-It only supports texture scrolling and scrolling speed features.(Cast shadow, receive shadow, transparency, reflection, and refraction are not supported.)

	5-2 module.
		-B1x1Stream00	Straight Stream
		-B1x1Stream2xUV00	It has twice the UV of a straight stream - half the speed of a straight stream.
		-B1x1StreamBandL00	Band Left Stream
		-B1x1StreamBandR00	Band Right Stream
		-B1x1StreamSlope00	Slope Stream - It connects a stream with a step difference.
		-B1x1StreamV00	Vertical Stream(This is similar to using a straight - the mesh itself is vertical.)

	5-3 Texture Example.
		-It contains basic bright stream, dark stream, lava A and lava B.
		-Contains the original PSD, You can edit the color in Photoshop.(StreamPSD.psd)
